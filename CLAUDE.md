...
- The Kickoff card's flyer thumbnail has a floating "Buy Tickets →" pill button (`.event-flyer-buy-btn`, in `.event-flyer-wrap`) overlaid on top of the image, linking straight to the Givebutter campaign. It's positioned with `left: 6%; bottom: 8%` to sit over the QR/"BUY TICKETS/DONATE HERE" corner that's baked into the flyer graphic itself, without covering the sponsor logos — if the flyer image is regenerated with a different layout, recheck this position still lines up.
